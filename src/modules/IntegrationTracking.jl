...
- 'L'        -- length
"""
@makekernel fastgtpsa=false function bkb_multipole!(i, b::BunchView, tilde_m, beta_0, theta, g, w::StaticMatrix{3,3}, w_inv::StaticMatrix{3,3}, k0, mm, kn, ks, L)
  knl = kn * L / 2
  ksl = ks * L / 2
  ExactTracking.multipole_kick!(i, b, mm, knl, ksl, 2)
  ExactTracking.exact_bend!(    i, b, theta, g, k0, w, w_inv, tilde_m, beta_0, L)
  ExactTracking.multipole_kick!(i, b, mm, knl, ksl, 2)
end 
