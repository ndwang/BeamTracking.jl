...
# ╔═╡ 60cfcb04-a94f-4396-946d-f267175cf02d
md""" 
This notebook introduces you to **tracking in SciBmad** and the use of **Pluto.jl notebooks**. The goal of this example is to ensure your simulations are portable and reproducible.

In this tutorial, we’ll learn how to load a lattice and explore various applications of our driver routine ```track!```.
"""

# ╔═╡ 1db55000-c591-4ffb-a039-490da5ca1a43
md"""First, we begin by including the necessary modules to enable tracking, along with some auxiliary packages.
Incidentally, this also demonstrates how to include code blocks within Markdown cells."""
...
```
Pluto.jl automatically downloads BeamTracking and its prerequisites, so there’s no need to use the package manager explicitly.
"

# ╔═╡ ca4b6a03-5862-4add-926e-72dc6c9715be
## Click an "eye" symbol on the left to show/hide cell code
...
md"""Let’s include our first lattice. This example uses the BNL ESR design, which is available in our test lattice suite.
**Note:** In Pluto.jl, multiline code cells must be enclosed with ```begin``` and ```end```."""

# ╔═╡ 70170189-454f-441e-9e2d-6199ca9cc838
md"""Contruct a particle bunch and track it trough ESR"""
...
# ╔═╡ 7a85a460-a616-4fa6-8ef8-f6fb6b4b68b4
md"""
You can see that ```b0``` is a bunch structure, storing information about a particle, a 2d array of phase space coordinates
"""

# ╔═╡ 322159ea-b385-490f-a4ca-6b1a8f9da885
md"""Finally lets plot our bunch, using Plots.jl"""

# ╔═╡ efb58b51-a889-42b6-ab94-30a72a3ab2ce
plot(
	scatter(b0.v[:,1], b0.v[:,2], label ="", xlabel = L"x", ylabel = L"p_x", markersize = 1),
	scatter(b0.v[:,3], b0.v[:,4], label ="", xlabel = L"y", ylabel = L"p_y", markersize = 1),
	scatter(b0.v[:,5], b0.v[:,6], label ="", xlabel = L"z", ylabel = L"p_z",
	markersize = 1),
	layout=(1,3), size=(600,300)
)

# ╔═╡ 0222d75e-29d6-4c68-9dd3-2138eaf9e665
...
[[deps.BeamTracking]]
deps = ["GTPSA", "ReferenceFrameRotations", "SIMD", "StaticArrays", "VectorizationBase"]
git-tree-sha1 = "ad9da9ca1b5a191640f79dcefeed6fbe9f2a4c70"
uuid = "8ef5c10a-4ca3-437f-8af5-b84d8af36df0"
version = "0.1.0"
weakdeps = ["Beamlines"]

    [deps.BeamTracking.extensions]
    BeamTrackingBeamlinesExt = "Beamlines"

[[deps.Beamlines]]
deps = ["Accessors", "GTPSA", "LinearAlgebra", "OrderedCollections", "StaticArrays"]
git-tree-sha1 = "d7ce4ab60de65a34f2d1d17c5349d0db02c022e0"
...
git-tree-sha1 = "bdc174c89eb762dc1aff4a58cfcd0ccce60671b4"
uuid = "b27dd330-f138-47c5-815b-40db9dd9b6e8"
version = "1.4.2"

[[deps.GTPSA_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl", "OpenBLAS32_jll"]
git-tree-sha1 = "421653d4ac27de5b1e34dd674169e8ac29c4adf5"
uuid = "a4739e29-4b97-5c0b-bbcf-46f08034c990"
version = "1.6.1+0"
...
git-tree-sha1 = "c1fadb2e94fa53c8bb8b937118e87d388012eaf6"
