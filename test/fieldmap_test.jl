@testset "FieldMap" begin
  ...
  @testset "Uniform Bz field - circular orbit" begin
    ...
    RungeKuttaTracking.rk4_kernel!(1, bunch.coords, beta_0, tilde_m,
                                    charge, p0c, mc2, z_range, ds_step, 100, field)
  ...
  @testset "Uniform Bz field map vs multipole solenoid" begin
    ...
    RungeKuttaTracking.rk4_kernel!(1, bunch_fm.coords, beta_0, tilde_m,
                                    charge, p0c, mc2, L, 0.01, 100, field_fm)
    ...
    RungeKuttaTracking.rk4_kernel!(1, bunch_mp.coords, beta_0, tilde_m,
                                    charge, p0c, mc2, L, 0.01, 100, field_mp)
  ...
  @testset "Uniform Ez field - energy gain" begin
    ...
    RungeKuttaTracking.rk4_kernel!(1, bunch.coords, beta_0, tilde_m,
                                    charge, p0c, mc2, L, 0.01, 100, field)
  ...
  @testset "Quadrupole field map vs multipole" begin
    ...
    field_fm = FieldMapSource(fm, 0.0, 0.0)
    RungeKuttaTracking.rk4_kernel!(1, bunch_fm.coords, beta_0, tilde_m,
                                    charge, p0c, mc2, L, 0.005, 100, field_fm)
    ...
    field_mp = MultipoleSource(mm, kn, ks, p_over_q_ref, 0.0)
    RungeKuttaTracking.rk4_kernel!(1, bunch_mp.coords, beta_0, tilde_m,
                                    charge, p0c, mc2, L, 0.005, 100, field_mp)
  ...
  @testset "Dead particles not updated" begin
    ...
    field = FieldMapSource(fm, 0.0, 0.0)
    RungeKuttaTracking.rk4_kernel!(1, bunch.coords, beta_0, tilde_m,
                                    charge, p0c, mc2, 0.9, 0.1, 9, field)
