...
ra1 = 15degree
ms_m1  = [ 3, 4, 5, 6 ]
bv_m1  = [ 0.18, 0.16, 0.14, 0.12 ];  # T/m^{n-1}

ra2 = 12degree
ms_m2  = [ 3, 4, 5, 6 ]
bv_m2  = [ 0.40, 0.30, 0.20, 0.10 ];  # T/m^{n-1}

ra3 = 9degree
ms_m3  = [ 3, 4, 5, 6 ]
bv_m3  = [ 1.00, 0.80, 0.60, 0.40 ];  # T/m^{n-1}

ra4 = 6degree
ms_m4  = [ 3, 4, 5, 6 ]
bv_m4  = [ 3.00, 2.40, 1.80, 1.20 ];  # T/m^{n-1}
...
pzf_mp1 = [ 0., 0.001, -0.001, 0.001, 0.001, 0.001, -0.001, -0.001 ]
...
pzf_mn1 = [ 0., 0.001, -0.001, 0.001, 0.001, 0.001, -0.001, -0.001 ]
...
@testset "Kernels" begin
    ...
    test_map(ExactTracking.ExactTracking.exact_drift!, "bmad_maps/drift.jl", drift_args(Float64)...; tol=5e-10)
    test_map(ExactTracking.ExactTracking.exact_solenoid!, "bmad_maps/solenoid.jl", solenoid_args(Float64)...; tol=5e-10)
    ...
    test_map(ExactTracking.ExactTracking.exact_drift!, "bmad_maps/drift.jl", drift_args(TPS64{D})...; tol=5e-10, TPS_params=true)
    test_map(ExactTracking.ExactTracking.exact_solenoid!, "bmad_maps/solenoid.jl", solenoid_args(TPS64{D})...; tol=5e-10, TPS_params=true)
