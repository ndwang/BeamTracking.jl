...
@testset "ExactTracking" begin
  @testset "Particles" begin
    ...
    theta = g * L 
    k0 = 1.001
    test_matrix(exact_bend_1, KernelCall(ExactTracking.exact_bend!, (theta, g, k0, tilde_m, beta_0, L)))
    ...
    L = 0.5
    theta = g * L
    test_matrix(exact_bend_2, KernelCall(ExactTracking.exact_bend!, (theta, g, k0, tilde_m, beta_0, L)))
    ...
    L = 0.5
    theta = g * L
    test_matrix(exact_bend_3, KernelCall(ExactTracking.exact_bend!, (theta, g, k0, tilde_m, beta_0, L)))
    ...
    L = 0.5
    theta = g * L
    test_matrix(exact_bend_4, KernelCall(ExactTracking.exact_bend!, (theta, g, k0, tilde_m, beta_0, L)))
    ...
    L = 0.5
    theta = g * L
    test_matrix(exact_bend_5, KernelCall(ExactTracking.exact_bend!, (theta, g, k0, tilde_m, beta_0, L)))
    ...
    L = 0.5
    theta = g * L
    test_matrix(exact_bend_6, KernelCall(ExactTracking.exact_bend!, (theta, g, k0, tilde_m, beta_0, L)))
